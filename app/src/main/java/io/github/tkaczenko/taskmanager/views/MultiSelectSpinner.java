package io.github.tkaczenko.taskmanager.views;

/**
 * Created by tkaczenko on 29.11.16.
 */
...
public class MultiSelectSpinner extends Spinner implements OnCancelListener {
    private static final String TAG = MultiSelectSpinner.class.getSimpleName();
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1, new String[]{spinnerText});
    ...
    public void setItems(List<KeyPairBoolData> items, int position, SpinnerListener listener) {
        ...
        ArrayAdapter<String> adapterSpinner = new ArrayAdapter<>(getContext(), android.R.layout.simple_list_item_1, new String[]{defaultText});
        setAdapter(adapterSpinner);
