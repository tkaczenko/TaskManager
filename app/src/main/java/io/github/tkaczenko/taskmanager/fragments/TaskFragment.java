...
import io.github.tkaczenko.taskmanager.adapters.TaskAdapter;
...
import io.github.tkaczenko.taskmanager.dialogs.AddTaskDialog;
...
public class TaskFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        taskDAO = new TaskDAOImp(activity);
            ...
            if (activityWeakRef.get() != null
                ...
                if (tasks != null) {
                    if (tasks.size() != 0) {
                        ...
                        Toast.makeText(activity, R.string.no_task_records,
